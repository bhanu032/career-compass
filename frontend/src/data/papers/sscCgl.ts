...
export const SSC_CGL_2024_SET1: MockPaper = {
  ...
  avgScore: 124,
  sections: [
    { id: S_REASON, name: "General Intelligence & Reasoning", shortName: "Reasoning", color: "#7c3aed", questionCount: 25, marks: 50, questions: reasoningQuestions },
    { id: S_GK, name: "General Awareness", shortName: "GK", color: "#0891b2", questionCount: 25, marks: 50, questions: gkQuestions },
    { id: S_QUANT, name: "Quantitative Aptitude", shortName: "Maths", color: "#059669", questionCount: 25, marks: 50, questions: quantQuestions },
    { id: S_ENG, name: "English Comprehension", shortName: "English", color: "#dc2626", questionCount: 25, marks: 50, questions: englishQuestions },
  ],
};
