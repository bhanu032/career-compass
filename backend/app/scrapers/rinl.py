    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. RINL / Vizag Steel — Navratna PSU.",
                state="Andhra Pradesh", category="PSU", job_type="job",
            ))
            if len(jobs) >= 30:
                break
        return jobs
