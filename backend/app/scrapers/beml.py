    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. BEML Limited — Miniratna PSU, Ministry of Defence.",
                state="All India", category="Defence PSU", job_type="job",
            ))
            if len(jobs) >= 30:
                break
        return jobs
