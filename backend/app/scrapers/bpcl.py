"""Bharat Petroleum Corporation Limited — bharatpetroleum.in"""
...
class BPCLScraper(BaseScraper):
    ...
    listing_url = "https://bharatpetroleum.in/careers/current-openings.aspx"
    requires_javascript = False
    KEYWORDS = ("recruit", "vacanc", "advertis", "notification", "post", "officer", "technician", "operator", "engineer", "trainee")
    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. Bharat Petroleum Corporation Limited (BPCL) — Maharatna PSU.",
