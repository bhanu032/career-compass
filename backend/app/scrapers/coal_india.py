"""
Scraper for Coal India Limited (CIL) — www.coalindia.in
Largest coal mining company, Navratna PSU.
"""
...
class CoalIndiaScraper(BaseScraper):
    ...
    base_url = "https://www.coalindia.in"
    listing_url = "https://www.coalindia.in/en-us/career/recruitment.aspx"
    requires_javascript = False

    KEYWORDS = ("recruit", "vacanc", "advertis", "notification", "post", "appointment", "trainee", "officer", "executive")
    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. Coal India Limited (CIL) — Navratna PSU.",
                state="All India",
                category="PSU",
                job_type="job",
            ))
