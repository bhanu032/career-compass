"""
Scraper for NABARD (National Bank for Agriculture and Rural Development) — www.nabard.org
"""
...
class NABARDScraper(BaseScraper):
    ...
    listing_url = "https://www.nabard.org/content.aspx?id=586&catid=23&mid=23"
    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. NABARD — National Bank for Agriculture and Rural Development.",
                state="All India",
                category="Banking",
                job_type="job",
            ))
