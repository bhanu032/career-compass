"""MTNL — mtnl.net.in — Mahanagar Telephone Nigam Limited"""
from typing import List
from app.scrapers.base import BaseScraper
from app.schemas.scraper import ScrapedJob
from app.utils.text import absolute_url, clean

class MTNLScraper(BaseScraper):
    source = "mtnl"
    name = "Mahanagar Telephone Nigam Limited"
    base_url = "https://www.mtnl.net.in"
    listing_url = "https://www.mtnl.net.in/Vacancies/vacancy_main.htm"
    requires_javascript = False
    KEYWORDS = ("recruit", "vacanc", "advertis", "notification", "post", "officer", "executive", "trainee")
    ...
    def parse(self, html: str) -> List[ScrapedJob]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            jobs.append(ScrapedJob(
                ...
                description=f"{title}. MTNL — Government telecom PSU.",
